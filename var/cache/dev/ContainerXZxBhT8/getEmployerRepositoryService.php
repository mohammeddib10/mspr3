 ...
 */
class getEmployerRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EmployerRepository' shared autowired service.
     *
     * @return \App\Repository\EmployerRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EmployerRepository.php';

        return $container->privates['App\\Repository\\EmployerRepository'] = new \App\Repository\EmployerRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
