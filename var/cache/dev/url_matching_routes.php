...
return [
    ...
    [ // $staticRoutes
        ...
        '/paie' => [[['_route' => 'gestion_paie', '_controller' => 'App\\Controller\\GestionPaieController::index'], null, ['GET' => 0, 'POST' => 1], null, true, false, null]],
    ],
    [ // $regexpList
        0 => '{^(?'
                .'|/_(?'
    ...
    [ // $dynamicRoutes
        ...
        239 => [[['_route' => 'employer_show', '_controller' => 'App\\Controller\\EmployerController::show'], ['id'], ['GET' => 0], null, false, true, null]],
        252 => [[['_route' => 'employer_edit', '_controller' => 'App\\Controller\\EmployerController::edit'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        260 => [
